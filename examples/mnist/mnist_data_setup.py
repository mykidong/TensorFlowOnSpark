...
def toTFExample(image, label):
    ...
    print("image: [" + image.astype("int64") + "], label: [" + label.astype("int64") + "]")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", help="HDFS directory to save examples in parallelized format",
                        default="mnist_data")
    ...
    if not args.read:
        ...
        writeMNIST(sc, "mnist/train-images-idx3-ubyte.gz", "mnist/train-labels-idx1-ubyte.gz", args.output + "/train",
                   args.format, args.num_partitions)
        writeMNIST(sc, "mnist/t10k-images-idx3-ubyte.gz", "mnist/t10k-labels-idx1-ubyte.gz", args.output + "/test",
                   args.format, args.num_partitions)
